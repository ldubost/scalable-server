...
var closeInactiveChannels = function (env, schedule, activeSet) {
    Object.keys(env.channels).forEach(channelName => {
        if (!activeSet.has(channelName)) {
...
// In any case, it will be re-opened if anyone tries to write to it.
            ...
            closeInactiveChannels: function (activeSet) {
                closeInactiveChannels(env, schedule, activeSet);
            },
            // write to a log file
